...
const reports = [
  { title: "Completion Report - BKT-2025-012", date: "May 20, 2026", farmer: "Juan Dela Cruz", machine: "Yanmar AG600" },
  { title: "Completion Report - BKT-2025-011", date: "May 15, 2026", farmer: "Maria Santos", machine: "Kubota SPU68" },
  { title: "Completion Report - BKT-2025-010", date: "May 08, 2026", farmer: "Pedro Reyes", machine: "Iseki PZ60" },
];
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray">{r.farmer} &middot; {r.machine} &middot; {r.date}</p>
              </div>
            </div>
